...
import 'package:weather_clean_architecture/features/weather_info/data/models/weather_info_remote_response_model/clouds_response_model.dart';
import 'package:weather_clean_architecture/features/weather_info/data/models/weather_info_remote_response_model/coordinate_response_model.dart';
import 'package:weather_clean_architecture/features/weather_info/data/models/weather_info_remote_response_model/main_weather_info_response_model.dart';
import 'package:weather_clean_architecture/features/weather_info/data/models/weather_info_remote_response_model/sunset_sunrise_response_model.dart';
import 'package:weather_clean_architecture/features/weather_info/data/models/weather_info_remote_response_model/weather_description_response_model.dart';
import 'package:weather_clean_architecture/features/weather_info/data/models/weather_info_remote_response_model/wind_info_response_model.dart';
...
class WeatherInfoResponseModel extends DataMapper<WeatherInfoEntity>{
  ...
  WeatherInfoEntity mapToEntity() {
    final List<WeatherDescriptionEntity>? _weatherDescription = weatherDescription?.
    map((WeatherDescriptionResponseModel weatherDescriptionEntity) => weatherDescriptionEntity.mapToEntity())
        .toList();
    final WeatherTypeEnum? weatherTypeEnum=_weatherDescription?[0].main?.toWeatherType();
